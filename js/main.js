...
// var sat2 = new Sphere(ctx, canvas.width/2, canvas.height/2 + 200, 10, -7, 0, 'lightsalmon', false, false, false)
// var sat3 = new Sphere(ctx, canvas.width/2 + 200, canvas.height/2, 10, 0, 7, 'lightsalmon', false, false, false)
// var sat4 = new Sphere(ctx, canvas.width/2, canvas.height/2 - 200, 10, 5, 0, 'lightgreen', false, true, false, goal1)
// var spaceShip = new SpaceShip(ctx, 100, canvas.height - 100, 10, 0, 0, 'grey', false)
// var bg = new Background(ctx, canvas.width, canvas.height) // TODO: maybe put this inside the spaceship??
