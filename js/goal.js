class Goal {
    constructor(ctx, x, y, radius, color = 'rgba(0, 255, 0, 0.5)', osc) {
        this.ctx = ctx
        this.x = x
        this.y = y
        this.radius = radius
    ...
    draw(osc) {
        this.ctx.save()
        this.gradient = ctx.createRadialGradient(this.x, this.y, this.radius/5, this.x, this.y, this.radius*osc+60)
